// features/shipping/components/edit-rate-dialog.tsx
...
import { ShippingRate, CreateShippingRateData, SERVICE_TYPES, CURRENCY_CODES } from '../types/rate.types';
...
export function EditRateDialog({
  ...
  // Initialize form with rate data
  useEffect(() => {
    if (rate) {
      setFormData({

// features/shipping/components/edit-zone-dialog.tsx
...
import { Zone, CreateZoneData, COMMON_COUNTRIES } from '../types/zone.types';
            ...
            <div className="grid grid-cols-2 gap-2 max-h-60 overflow-y-auto border rounded p-3">
              {COMMON_COUNTRIES.map(country => (
                <div key={country.code} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={`edit-country-${country.code}`} className="text-sm cursor-pointer">
